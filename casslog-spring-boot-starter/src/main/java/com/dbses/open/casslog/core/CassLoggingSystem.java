 ...
 * @date 2021/10/22
 */
public class CassLoggingSystem extends LogbackLoggingSystem {
    ...
    protected void loadConfiguration(LoggingInitializationContext initializationContext,
        ...
        // from Slf4JLoggingSystem # loadConfiguration() <<
    ...
    private void configureByResourceUrl(
        ...
        if (url.toString().endsWith("xml")) {
            JoranConfigurator configurator = new CassLogJoranConfigurator(initializationContext);
